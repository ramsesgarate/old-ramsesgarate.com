  ...
  <Layout>
    <section class="">
      ...
      <div class="post-footer">
        <a :href="editLink" target="_blank" rel="noopener noreferrer" class="link-edit-page">
          <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 438.549 438.549">
